...
int main(int argc, char** argv) {
    ...
    char number2[]="11234567890123456789123";
    int setPwid=sizeResult(number1,number2);
    char result[setPwid];
    //Add the numbers
    cout<<setw(setPwid)<<number1<<endl;
    cout<<setw(setPwid)<<number2<<endl;
    bool x=numberAdd(number1,number2,result);
    if(x)cout<<"overflow"<<endl;
    else cout<<setw(setPwid)<<result<<endl;
